...
export default function GomuCharacter({ size = 80, className = '' }: GomuCharacterProps) {
  return (
    ...
    >
      ...
      {/* 몸통 */}
      <ellipse cx="50" cy="74" rx="38" ry="29" fill="#D96B18" />
      {/* 몸통 상단 하이라이트 */}
      <ellipse cx="43" cy="61" rx="22" ry="12" fill="#F5933A" opacity="0.45" />
      {/* 몸통 하단 음영 */}
      <ellipse cx="54" cy="88" rx="20" ry="10" fill="#B55510" opacity="0.3" />
